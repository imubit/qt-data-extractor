...
Welcome to `qt-data-extractor` contributor's guide.
...
If you experience bugs or general issues with `qt-data-extractor`, please have a look
...
You can help improve `qt-data-extractor` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`qt-data-extractor` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `qt-data-extractor`'s files. While this mechanism can
...
```
conda create -n qt-data-extractor python=3 six virtualenv pytest pytest-cov
conda activate qt-data-extractor
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/qt-data-extractor.git
   cd qt-data-extractor
   ```
...
5. Install [pre-commit]:
   ...
   `qt-data-extractor` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/qt-data-extractor
[issue tracker]: https://github.com/<USERNAME>/qt-data-extractor/issues
